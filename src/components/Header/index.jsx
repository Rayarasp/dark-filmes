...
export default function Header({showButton = true}){
    return(
        <header className="w-full h-[70px] flex bg-[#0c0f15] justify-between pr-2 items-center">
            ...
            className="flex h-full cursor-pointer gap-2 items-center justify-center pl-2">
            ...
            {showButton && (
                ...
                className="w-[150px] h-[60%] rounded-md bg-[#9887f5] font-bold hover:bg-[#9887f5]/70 cursor-pointer">Adicionar Filme</button>
            ) }
